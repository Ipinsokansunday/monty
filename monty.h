...
void s_nop(stack_t **stack_head, unsigned int num_count);
...
void s_mod(stack_t **stack_head, unsigned int num_count);
void s_pchar(stack_t **stack_head, unsigned int num_count);
void s_pstr(stack_t **stack_head, unsigned int num_count);
void s_rotl(stack_t **stack_head, unsigned int num_count);
void s_rotr(stack_t **stack_head, __attribute__((unused)) unsigned int num_count);
...
void s_stack(stack_t **stack_head, unsigned int num_count);
